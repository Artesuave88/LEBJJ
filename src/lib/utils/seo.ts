import { SITE_DESCRIPTION, SITE_NAME, SITE_TAGLINE, SITE_URL } from '$lib/config/site'
...
const ROUTE_SEO: Record<string, RouteSeoInput> = {
  ...
  '/coaches': {
    title: 'Instructors',
    description: 'Meet the Long Eaton BJJ instructor team and learn about their approach to development.'
  },
  '/kids': {
    title: 'Kids BJJ',
