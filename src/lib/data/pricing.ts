...
export const pricingFaqs = [
  {
    ...
    answer:
      "No experience is required. Our beginner trial is designed for first-time students.",
  },
  {
    question: "Can I attend both Gi and No-Gi classes?",
    answer:
      "Yes. Monthly memberships can include both Gi and No-Gi timetable options.",
  },
  {
    question: "Are there contracts?",
    answer:
      "Membership terms can vary. Contact us and we will explain your options clearly.",
  },
  {
    question: "What if I am only interested in kids classes?",
    answer:
      "The kids membership is tailored for juniors and teens with age-appropriate sessions.",
  },
];
